...
exports.default = function (_ref) {
    ...
    var FormInspectorComponent = function FormInspectorComponent(BaseComponent) {
        return (0, _reactRedux.connect)(function (state) {
            ...
            var errors = _extends({}, (0, _reduxForm.getFormAsyncErrors)(form)(state), (0, _reduxForm.getFormSyncErrors)(form)(state));

            var inspection = Object.keys(fieldsToProps).reduce(function (r, prop) {
                return _extends({}, r, _defineProperty({}, prop, fieldValues ? fieldsToProps[prop](fieldValues, errors) : null));
            }, {});
